...
for course_code in course_codes:
    ...
    for i, table in enumerate(soup.findAll('table', {"class": "course-page__course-structure"})):
        ...
        with open("output/" + file_name, "w") as json_file:
            ...
            courseAOS = table
            while(courseAOS.get("class") != "scroll-wrapper"):
                courseAOS = courseAOS.parent
            output_dict = {"courseCode": course_code, "courseName": courseName, "courseType": courseType, "teachingPeriods": [], "faculty": "Faculty of " + course_info["Managing faculty"], "courseAOS": courseAOS.getText()}
